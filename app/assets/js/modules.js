...
/* ↑↑↑ ??? ↑↑↑ */
////////////////////////////////////////////////////////////////////////////////
"use strict"; // contact form module
////////////////////////////////////////////////////////////////////////////////

/* ↓↓↓ увімкн/вимкнення форми ↓↓↓ */

var isContactFormOpen = false;
...
if (document.querySelector('.form-contact__tassel')) {
  document.querySelector('.form-contact__tassel').onclick = function () {
    if (isContactFormOpen) {
      ...
      var formWidth = document.getElementById('contactForm').offsetWidth;
      document.getElementById('contactForm').style.left = 'calc(100% - ' + formWidth + 'px)';
      var messages = document.querySelectorAll('.form-contact__form-error');
...
if (document.getElementById('submitContact')) {
  document.getElementById('submitContact').onclick = function (event) {
    event.preventDefault(); // валідація імені
    ...
    var address = document.getElementById('contact-email').value;
...
if (document.getElementById('submitLogin')) {
  document.getElementById('submitLogin').onclick = function (event) {
    event.preventDefault(); // валідація пошти

    var address = document.getElementById('login-email').value;
    ...
    if (!password) {
      ...
      if (passwordArr.length < 8 || passwordArr.length == tempCount || tempCount == 0) {
...
/* ↑↑↑ показати/приховати пароль ↑↑↑ */
////////////////////////////////////////////////////////////////////////////////
"use strict"; // registration form module
////////////////////////////////////////////////////////////////////////////////
...
if (document.getElementById('submitRegistration')) {
  document.getElementById('submitRegistration').onclick = function (event) {
    ...
    var passwordRepeat = document.getElementById('password-rep').value;
    ...
    var check = document.querySelector('.form-registration__form-group_with-check input[type="checkbox"]');
    ...
    var ccode = document.getElementById('ccode').value.toString().slice(1); // формування даних, відправка на сервер, перенаправлення на торгову платформу
    ...
    var lang = document.querySelector('.header__lang').innerHTML.toLowerCase();
    $.ajax({
  ...
  document.querySelector('.form-registration__current-country-wrapper').onclick = function (event) {
    ...
    if (!isCountryListOpen) {
      ...
      for (var i = 0; i < countriesArr.length; i++) {
        var item = '<div class="form-registration__country-item" data-ccode="' + countriesArr[i].phoneCode + '" onclick="selectCountry(this)">\
...
/* ↑↑↑ побудова списку країн ↑↑↑ */
////////////////////////////////////////////////////////////////////////////////
"use strict"; // peset password form module
////////////////////////////////////////////////////////////////////////////////
...
if (document.getElementById('submitPasswordReset')) {
  document.getElementById('submitPasswordReset').onclick = function (event) {
    ...
    var address = document.getElementById('email-reset').value;
    ...
    var check = document.querySelector('.form-reset-pass__form-group_with-check input[type="checkbox"]');
...
if (document.querySelector('.form-reset-pass__form-group_with-check')) {
  var isAgreementWith24Checked = false;
...
document.querySelector('.header__lang').onclick = function (e) {
  // поточне посилання
  var href = window.location.href; // захист від порожніх посилань
  ...
  var selectedLanguage = event.target.innerHTML.toLowerCase();

...
$('#btnsubmit').click(function () {
  ...
  $.ajax({
        url     : "https://crm.globaltradeinvesting.com/api/LidsSelfRegisr",
        type    : "POST",
        data    : dat,
        success : function (data) {
                    if (data=="Ok") {
                      location.href = 'https://platform.globaltradeinvesting.com/Home/LoginSite?email=' + dat.CustomerEmail + '&pass=' + dat.CustomerPassword
                    } else {
                      // якщо повідомлення уже є - вийти
